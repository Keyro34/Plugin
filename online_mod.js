...
(function () {
    ...
    function proxy(name) {
      ...
      var proxy1 = Lampa.Platform.is('android') ? 'https://cors.lampa.workers.dev/' : 'https://keyro.prokeyro-9c7.workers.dev/';
    ...
    function rezka2FillCookie(success, error) {
      ...
      if (false && !prox && !returnHeaders) prox = Utils.proxy('cookie');
