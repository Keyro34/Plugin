...
(function () {
    ...
    function injectPrestigeCSS() {
      ...
      style.textContent = [
        /* ── Основная ячейка — сброс Lampa .selector абсолютного позиционирования ── */
        '.online-prestige {',
        ...
        '  bottom: auto !important;',
        '}',
        /* Держим пропорцию 16:9 через pseudo-element */
        '.online-prestige__img::before {',
        '  content: "" !important;',
        '  display: block !important;',
        ...
        /* ── Номер эпизода — переопределяем Lampa .selector ── */
