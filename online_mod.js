...
(function () {
    ...
    function rezka2(component, _object) {
      ...
      var host = (!prox || proxy_mirror) ? Utils.rezka2Mirror() : (Lampa.Platform.is('android') ? 'https://rezka.si' : Utils.rezka2Mirror());
      var ref = host + '/';
    ...
    function rezka2FillCookie(success, error) {
      ...
      var returnHeaders = androidHeaders;
      var proxy_mirror = Lampa.Storage.field('online_mod_proxy_rezka2_mirror') === true;
      var host = prox && !proxy_mirror ? 'https://rezka.si' : Utils.rezka2Mirror();
