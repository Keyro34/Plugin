...
(function () {
    ...
    function addStyles() {
        var style = `
        <style>
        /* Основные стили для карточек как на втором изображении */
        .online-card {
            display: flex;
        ...
        /* Стили для похожих результатов (папки) */
        .online-folder {
            display: flex;
            align-items: center;
        ...
        .online-folder__icon svg {
            width: 100%;
            height: 100%;
            fill: #ffd700;
        }
        
        .online-folder__content {
            flex: 1;
        }
        
        .online-folder__title {
            font-size: 1.2em;
            color: #fff;
            margin-bottom: 0.3em;
        }
        ...
        .online-watched__icon svg {
            width: 100%;
            height: 100%;
        }
        
        .online-watched__body {
            display: flex;
            flex-wrap: wrap;
            gap: 0.5em;
            color: #aaa;
        ...
        .online-watched__body span {
            color: #ffd700;
        }
        
        .online-watched__body span + span::before {
            content: "•";
            margin-right: 0.5em;
            color: #aaa;
        }
        ...
        /* Стили для иконки просмотра в старом формате (на всякий случай) */
        .icon-viewed {
            width: 1.2em;
            height: 1.2em;
            fill: #4CAF50;
        ...
        .loading-spinner {
            ...
            border-top-color: #ffd700;
            border-radius: 50%;
            animation: online-card-spin 1s linear infinite;
        }
        </style>
        `;
